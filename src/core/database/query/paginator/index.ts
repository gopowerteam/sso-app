import { PaginatorMode } from '../../database.enums'
...
export function buildPaginator<Entity>(
  ...
  switch (options.mode) {
    case PaginatorMode.Cursor:
      return builderCursorPaginator(options as CursorPaginationOptions<Entity>)
    case PaginatorMode.Index:
      return builderIndexPaginator(options as IndexPaginationOptions<Entity>)
  }
}
